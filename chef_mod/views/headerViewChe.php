...
Documento: "headerViewChe.php"  Version:  1.0.
Descripción: Vista plantilla general para pintar el header y el background de todas
las vistas que se rendericen en el módulo chef.
...
<html>
    <head>
        ...
        <!-- AGREGANDO ESTILOS -->
        <link rel="stylesheet" href="/Easy_Order_Dev_ARC/chef_mod/views/css/misestilosche.css">
        <!-- AGREGANDO ESTILOS --> 
                ...
                <nav class="nav navbar">
                    ...
                    <div class="container-fluid col-md-3 col-sm-4">
                        <a  class="navbar-brand" href="#">
                            <img src="/Easy_Order_Dev_ARC/chef_mod/views/img/EOlogoXSWFondo3.png">
                        </a>                        
                    </div>
                    <!---  LOGO EO  --->
